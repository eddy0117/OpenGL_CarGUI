...
class DrawFunctions:
    ...
    def get_model_info(cls, model_dict, view=None, projection=None):
        ...
        shader = compileProgram(compileShader(cls.vertex_src, GL_VERTEX_SHADER), compileShader(cls.fragment_src, GL_FRAGMENT_SHADER))
        ...
        for idx, (model_name, model_content) in enumerate(model_dict.items()):
            ...
            model_indices, model_buffer = ObjLoader.load_model(cls.model_path_prefix + model_content[0])
